define([
    ...
    Batch.prototype.add = function(updater, instance) {
        ...
        if (!updater.hasConstantFill || !updater.fillMaterialProperty.isConstant || !Property.isConstant(updater.distanceDisplayConditionProperty) || !Property.isConstant(updater.offsetProperty)) {
    ...
    Batch.prototype.update = function(time) {
        ...
        if (this.createPrimitive) {
            ...
            for (i = 0; i < length; i++) {
                ...
                var offsetProperty = updater.offsetProperty;
