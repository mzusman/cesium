define([
    ...
    function PolygonGraphics(options) {
        ...
        this._relativeToTerrain = undefined;
        this._relativeToTerrainSubscription = undefined;
    ...
    defineProperties(PolygonGraphics.prototype, {
        ...
        relativeToTerrain : createPropertyDescriptor('relativeToTerrain')
    });
    ...
    PolygonGraphics.prototype.clone = function(result) {
        ...
        result.relativeToTerrain = this.relativeToTerrain;
    ...
    PolygonGraphics.prototype.merge = function(source) {
        ...
        this.relativeToTerrain = defaultValue(this.relativeToTerrain, source.relativeToTerrain);
    };
