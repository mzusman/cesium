define([
    ...
    PolygonGeometry.computeRectangle = function(positions, ellipsoid, result) {
        //>>includeStart('debug', pragmas.debug);
        ...
        if (!defined(positions) || positions.length < 3) {
            ...
            result = Rectangle.fromCartesianArray(positions, ellipsoid, result);
        }
        return result;
    };
        ...
        rectangle : {
            get : function() {
                if (!defined(this._rectangle)) {
                    this._rectangle = PolygonGeometry.computeRectangle(this._polygonHierarchy.positions, this._ellipsoid, new Rectangle());
                }
